...
#if LCD_HEIGHT > 3
    lcd.setCursor(0, 2);                          //was 0,2
    lcd.print(LCD_STR_FEEDRATE[0]);
    lcd.print(itostr3(feedmultiply));
    lcd.print('%');
# if LCD_WIDTH > 19
#  ifdef SDSUPPORT
    lcd.setCursor(7, 2);                       //     7,2
    lcd_printPGM(PSTR("SD"));
    if (IS_SD_PRINTING)
        lcd.print(itostr3(card.percentDone()));
    else
...
# endif//LCD_WIDTH > 19
  ...
  lcd.setCursor(0, LCD_HEIGHT - 1);         //julia edit to make status and bar show together
